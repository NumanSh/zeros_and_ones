...
public class UIDragAndDrop : MonoBehaviour, IDragHandler, IEndDragHandler, IBeginDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        if (isOverGreenArea && gatePrefab != null)
        {
            ...
            GameObject newPiece = Instantiate(gatePrefab, mouseWorldPos+offsit, Quaternion.identity);
          
            SaveManager.SaveSinglePlacedItem(gatePrefab.name, newPiece.transform.position);
